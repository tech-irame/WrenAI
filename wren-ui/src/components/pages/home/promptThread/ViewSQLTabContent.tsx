...
export default function ViewSQLTabContent(props: AnswerResultProps) {
  ...
  const onCopy = () => {
    if (!nativeSQLResult.nativeSQLMode) {
      message.success(
        <>
          You copied Irame SQL. This dialect is for the Irame Engine and may not
  ...
  return (
    <div className="text-md gray-10 p-6 pb-4">
      <Alert
        ...
        message={
          <>
            You’re viewing Irame SQL by default. If you want to run this query on
          ...
          <div>
            {nativeSQLResult.nativeSQLMode ? (
              ...
              <span className="d-flex align-center gx-2">
                <Logo size={18} />
                <Text className="gray-8 text-medium text-sm">Irame SQL</Text>
              </span>
            )}
          </div>

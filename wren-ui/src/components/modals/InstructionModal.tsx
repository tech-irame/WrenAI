    ...
    >
      <Form form={form} preserve={false} layout="vertical">
        ...
        >
          <Input.TextArea
            autoFocus
            placeholder="Enter a rule that Irame AI should follow when generating SQL queries."
            maxLength={1000}
            rows={3}
            showCount
          />
        ...
        {!isDefault && (
          <Form.Item
            ...
            required
            extra="Irame AI will match user queries based on similarity and apply this instruction when relevant."
          >
